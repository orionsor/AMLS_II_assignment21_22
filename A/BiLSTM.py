...
def data_load(data_root,label_root):
    """load data generated by data_process_ekphrasis if run this script directly"""
...
def train_model(model, X_train, Y_train, X_val, Y_val,filepath):
    ...
    model.fit(X_train, Y_train, validation_data=(X_val, Y_val), epochs=1, batch_size=256, shuffle=True,
              callbacks=callbacks_list)


def plot_acc_loss(history):
    """plot learning curve graoh"""
